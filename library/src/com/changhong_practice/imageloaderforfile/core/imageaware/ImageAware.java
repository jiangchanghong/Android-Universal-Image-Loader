 ...
 * through {@link com.changhong_practice.imageloaderforfile.core.ImageLoader ImageLoader}.
...
public interface ImageAware {
	 ...
	 * {@linkplain com.changhong_practice.imageloaderforfile.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *android.graphics.drawable.Drawable) for empty Uri},
	 * {@linkplain com.changhong_practice.imageloaderforfile.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *android.graphics.drawable.Drawable) on loading} or
	 * {@linkplain com.changhong_practice.imageloaderforfile.core.DisplayImageOptions.Builder#showImageOnFail(
	 *android.graphics.drawable.Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain com.changhong_practice.imageloaderforfile.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link com.changhong_practice.imageloaderforfile.core.display.BitmapDisplayer BitmapDisplayer}.
	 *
	 ...
	 * {@link com.changhong_practice.imageloaderforfile.core.display.BitmapDisplayer BitmapDisplayer}.
	 *
