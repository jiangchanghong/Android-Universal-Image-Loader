 ...
 * @since 1.0.0
 */
public class DiscCacheForSmallImage extends BaseDiscCache {

	/** @param cacheDir Directory for file caching */
	public DiscCacheForSmallImage(File cacheDir) {
	 ...
	 */
	public DiscCacheForSmallImage(File cacheDir, FileNameGenerator fileNameGenerator) {
